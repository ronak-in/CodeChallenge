package com.codechallenge.utilities
...
inline fun FragmentActivity.replaceFragmentWithBackStack(containerViewId: Int, f: () -> Fragment): Fragment? {
    return f().apply {
        supportFragmentManager?.beginTransaction()?.replace(containerViewId, this)?.addToBackStack("fragment").commit()
    }
}
